...
void CRC0Structure::FillGlobalMatrix(complex<double> **Ym, double w)
{
  complex<double> Mat_rc[4][4]; // Y - параметры RC - €чейки
...
int CRC0Structure::FixElement(int Element)
{
