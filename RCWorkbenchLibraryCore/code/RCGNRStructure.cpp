...
{
    // RkCNRk
    complex<double> Mat_Rk_C_NRk[8][8]{0}; // Y - параметры Rk_C_NRk - ячейки
    ...
    // RkCNR
    complex<double> Mat_Rk_C_NR[8][8]{0}; // Y - параметры Rk_C_NR - ячейки
    ...
    // RCNRk
    complex<double> Mat_R_C_NRk[8][8]{0}; // Y - параметры R_C_NRk - ячейки
